...
void cpu_t::reset_cpu(){									
	switch (cycles){                                                                        
		case 1: break;                                                                  
		case 2: addr_bus++;break;                                                       
		case 3: addr_bus=sp+0x100;break;                                                
		case 4: addr_bus=(sp-1)+0x100;break;                                            
		case 5: addr_bus=(sp-2)+0x100;break;                                            
		case 6: addr_bus=0xfffc;pc=bus->read(addr_bus);break;	                        
		case 7: addr_bus=0xfffd;pc=bus->read(addr_bus)<<8;cycles=0;break;            
	}                                                                                       
}                                                                                               
//NMI
...
//clock
void cpu_t::clock(){
	if (!reset){reset_cpu();instr_complete=true}
